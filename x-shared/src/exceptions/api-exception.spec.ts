...
describe('ApiException', () => {
  ...
  it('can instantiate with an service name and a message', () => {
    ...
    expect(apiException.message).toEqual('Api service "TestService": Test message');
  });
  ...
  it('can instantiate with null service name and message, but default values are applied', () => {
    ...
    expect(apiException.message).toEqual('Api service [no api service]: [no exception message]');
  });
